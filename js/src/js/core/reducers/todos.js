...
function todos(state, action) {
    ...
    switch (action.type) {
        ...
        case c.TASK_VISIBLE:
            newState.todos.some(item => item.id == action.id ? item.isExpanded = !item.isExpanded : null);
            return newState;

        case c.TODO_DETAILS:
            newState.todos.some(item => item.id == action.id ? item.editDialogVisible = action.visible : null);
        ...
        case c.TODO_EDIT_NAME_DIALOG:
            ...
            newState.activity.detailsEditNamePartialData = newState.todos.find(item => item.id == newState.activity.detailsTodoId ? item : null).todoName;
            return newState;
        ...
        case c.TODO_EDIT_NAME_CONFIRM_SUBMIT:
            newState.activity.detailsEditNameShowConfirm = false;
            newState.activity.detailsEditNameShowDialog = false;
            newState.todos.some(item => item.id == newState.activity.detailsTodoId ? item.todoName = newState.activity.detailsEditNamePartialData : null)
            newState.activity.detailsEditNamePartialData = '';
            return newState;
        ...
        case c.TASK_DELETE_CONFIRM_SUBMIT:
            newState.todos.some(item => item.id == newState.activity.detailsTodoId ? item.tasks = item.tasks.filter(subItem => subItem.id != action.id) : null)
            newState.activity.detailsDeleteTaskShowConfirm = false;
            newState.activity.detailsDeleteTaskTaskId = '';
            return newState;
        ...
        case c.TASK_EDIT_NAME_DIALOG:
            ...
            newState.activity.detailsEditTaskPartialData = newState.todos.find(item => item.id == newState.activity.detailsTodoId).tasks.find(subItem => subItem.id == action.id ? subItem : null).taskName;
            return newState;
        ...
        case c.TASK_EDIT_NAME_CONFIRM_SUBMIT:
            newState.activity.detailsEditTaskShowConfirm = false;
            newState.activity.detailsEditTaskShowDialog = false;
            newState.todos.some(item => item.id == newState.activity.detailsTodoId ? item.tasks.some(subItem => subItem.id == newState.activity.detailsEditTaskTaskId ? subItem.taskName = newState.activity.detailsEditTaskPartialData : null) : null)
            newState.activity.detailsEditTaskPartialData = '';
            return newState;
        ...
        case c.TASK_CHECK_CONFIRM_SUBMIT:
            newState.todos.some(item => item.id == newState.activity.detailsTodoId ? item.tasks.some(subItem => subItem.id == action.id ? subItem.isDone = !subItem.isDone : null) : null)
            newState.activity.detailsCheckTaskShowConfirm = false;
            newState.activity.detailsCheckTaskTaskId = '';
            return newState;
        ...
        case c.TASK_NEW_CONFIRM_SUBMIT:
            newState.todos.some(item => item.id == newState.activity.detailsTodoId ? item.tasks.push({
                id: randomString(20),
