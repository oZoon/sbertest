...
export const newTodoPartialData = ({ data: { text } }) => {
    return {
...
export const taskVisible = ({ data: { id } }) => {
    return {
        type: c.TASK_VISIBLE,
        id,
    }
...
export const openTodoDetails = ({ data: { id } }) => {
    return {
        type: c.TODO_DETAILS,
        visible: true,
        id,
...
export const closeTodoDetails = ({ data: { id } }) => {
    return {
        type: c.TODO_DETAILS,
        visible: false,
        id,
...
export const deleteToDoSubmit = ({ data: { id } }) => {
    return {
...
export const editTodoNamePartialData = ({ data: { text } }) => {
    return {
...
export const deleteTaskConfirmSubmit = ({ data: { id } }) => {
    return {
...
export const editTaskName = ({ data: { id } }) => {
    return {
...
export const editTaskNamePartialData = ({ data: { text } }) => {
    return {
...
export const checkTask = ({ data: { id } }) => {
...
export const checkTaskConfirmSubmit = ({ data: { id } }) => {
    return {
...
export const newTaskPartialData = ({ data: { text } }) => {
    return {
