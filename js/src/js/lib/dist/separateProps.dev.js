...
var _default = function _default(props) {
  var state = props.state,
      onNewTodoDialog = props.onNewTodoDialog,
      onNewTodoCancel = props.onNewTodoCancel,
      onNewTodoSubmit = props.onNewTodoSubmit,
      onNewTodoPartialData = props.onNewTodoPartialData,
      onNewTodoConfirmCancel = props.onNewTodoConfirmCancel,
      onNewTodoConfirmSubmit = props.onNewTodoConfirmSubmit,
      onTaskVisible = props.onTaskVisible,
      onOpenTodoDetails = props.onOpenTodoDetails,
      onCloseTodoDetails = props.onCloseTodoDetails,
      onDeleteTodo = props.onDeleteTodo,
      onDeleteTodoCancel = props.onDeleteTodoCancel,
      onDeleteToDoSubmit = props.onDeleteToDoSubmit,
      onEditTodoName = props.onEditTodoName,
      onEditTodoNameCancel = props.onEditTodoNameCancel,
      onEditTodoNameSubmit = props.onEditTodoNameSubmit,
      onEditTodoNamePartialData = props.onEditTodoNamePartialData,
      onEditTodoNameConfirmCancel = props.onEditTodoNameConfirmCancel,
      onEditTodoNameConfirmSubmit = props.onEditTodoNameConfirmSubmit,
      onEditTaskName = props.onEditTaskName,
      onEditTaskNameCancel = props.onEditTaskNameCancel,
      onEditTaskNameSubmit = props.onEditTaskNameSubmit,
      onEditTaskNamePartialData = props.onEditTaskNamePartialData,
      onEditTaskNameConfirmCancel = props.onEditTaskNameConfirmCancel,
      onEditTaskNameConfirmSubmit = props.onEditTaskNameConfirmSubmit,
      onDeleteTask = props.onDeleteTask,
      onDeleteTaskConfirmCanCel = props.onDeleteTaskConfirmCanCel,
      onDeleteTaskConfirmSubmit = props.onDeleteTaskConfirmSubmit,
      onCheckTask = props.onCheckTask,
      onCheckTaskConfirmCancel = props.onCheckTaskConfirmCancel,
      onCheckTaskConfirmSubmit = props.onCheckTaskConfirmSubmit,
      onNewTask = props.onNewTask,
      onNewTaskCancel = props.onNewTaskCancel,
      onNewTaskSubmit = props.onNewTaskSubmit,
      onNewTaskPartialData = props.onNewTaskPartialData,
      onNewTaskConfirmCancel = props.onNewTaskConfirmCancel,
      onNewTaskConfirmSubmit = props.onNewTaskConfirmSubmit;
  ...
  var modalDetailTodo = {
    ...
    width: '800px',
    minHeight: "".concat(60 + _constants.COUNT_TASK[1] * 50 + 20 + 62 + 90, "px"),
    zIndex: Number('2')
  };
