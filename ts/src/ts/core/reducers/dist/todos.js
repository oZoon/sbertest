...
function todos(state, action) {
    ...
    switch (action.type) {
        ...
        case c.TODO_DELETE_CONFIRM_SUBMIT:
            newState.todos = newState.todos.filter(function (item) { return item.id != action.id; });
            newState.activity.deleteTodoShowConfirm = false;
            newState.activity.deleteTodoTodoId = '';
            return newState;
        case c.TODO_EDIT_NAME_DIALOG:
            newState.activity.detailsEditNameShowDialog = true;
            newState.activity.detailsEditNamePartialData = newState.todos.find(function (item) { return item.id == newState.activity.detailsTodoId ? item : null; }).todoName;
            return newState;
        ...
        case c.TODO_EDIT_NAME_CONFIRM_SUBMIT:
            newState.activity.detailsEditNameShowConfirm = false;
            newState.activity.detailsEditNameShowDialog = false;
            newState.todos.some(function (item) { return item.id == newState.activity.detailsTodoId ? item.todoName = newState.activity.detailsEditNamePartialData : null; });
            newState.activity.detailsEditNamePartialData = '';
            return newState;
        ...
        case c.TASK_DELETE_CONFIRM_SUBMIT:
            newState.todos.some(function (item) { return item.id == newState.activity.detailsTodoId ? item.tasks = item.tasks.filter(function (subItem) { return subItem.id != action.id; }) : null; });
            newState.activity.detailsDeleteTaskShowConfirm = false;
            newState.activity.detailsDeleteTaskTaskId = '';
            return newState;
        case c.TASK_EDIT_NAME_DIALOG:
            ...
            newState.activity.detailsEditTaskPartialData = newState.todos.find(function (item) { return item.id == newState.activity.detailsTodoId; }).tasks.find(function (subItem) { return subItem.id == action.id ? subItem : null; }).taskName;
            return newState;
        ...
        case c.TASK_EDIT_NAME_CONFIRM_SUBMIT:
            newState.activity.detailsEditTaskShowConfirm = false;
            newState.activity.detailsEditTaskShowDialog = false;
            newState.todos.some(function (item) { return item.id == newState.activity.detailsTodoId ? item.tasks.some(function (subItem) { return subItem.id == newState.activity.detailsEditTaskTaskId ? subItem.taskName = newState.activity.detailsEditTaskPartialData : null; }) : null; });
            newState.activity.detailsEditTaskPartialData = '';
            return newState;
        ...
        case c.TASK_CHECK_CONFIRM_SUBMIT:
            newState.todos.some(function (item) { return item.id == newState.activity.detailsTodoId ? item.tasks.some(function (subItem) { return subItem.id == action.id ? subItem.isDone = !subItem.isDone : null; }) : null; });
            newState.activity.detailsCheckTaskShowConfirm = false;
            newState.activity.detailsCheckTaskTaskId = '';
            return newState;
        ...
        case c.TASK_NEW_CONFIRM_SUBMIT:
            newState.todos.some(function (item) { return item.id == newState.activity.detailsTodoId ? item.tasks.push({
